#  задача 1, надо получить Результат: "ver"
some_string = "Adverts"
print(some_string[2:5])
# задача 2, надо получить Результат: "AAiddialneat"
ai = "Aidana"
ad = "Adilet"
print(ai[0]+ad[0]+ai[1]+ad[1]+ai[2]+ad[2]+ai[3]+ad[3]+ai[4]+ad[4]+ai[5]+ad[5])
# задача 3, Вам дается текст:
